...
CREATE TRIGGER PLACE_ORDER_TRG
BEFORE INSERT ON ORDERS
FOR EACH ROW
BEGIN
	DECLARE CURRENT_STK INT;
    SELECT CURRENT_STOCK INTO CURRENT_STK FROM PRODUCTS WHERE PRODUCT_ID = NEW.PRODUCT_ID;
    
    IF CURRENT_STK = 100 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'No stock available';
    END IF;
END;
//
