...
import com.assignment.orderservice.feignclients.fallbacks.AddressServiceFeignClientFallBack;

@FeignClient(name = "userservice", fallback = AddressServiceFeignClientFallBack.class)
